...
#
# This file is part of Tensorflow-NewtonOptimizer.
#
# Tensorflow-NewtonOptimizer is free software: you can redistribute it and/or modify
# it under the terms of the GNU General Public License as published by
# the Free Software Foundation, either version 3 of the License, or
# (at your option) any later version.
#
# Tensorflow-NewtonOptimizer is distributed in the hope that it will be useful,
...
class NewtonOptimizer:
    ...
    def __init__(self, learning_rate, learning_rate_sgd=1e-4, alpha=0.6, hessian_period=1, name='NewtonOptimizer'):
        ...
        ----------
        learning_rate : float
            Defines the size of the step of the Newton update.
        learning_rate_sgd : float
            Defines the size of the state of the stochastic gradient descent update.
            Stochastic gradient descent step will be performed if the hessian's determinant is zero.
        alpha : float
            The hessian will be update as follows:
            hessian = hessian + alpha * eye,
            where eye is the identity matrix.
            This addition helps to improve the stability of the optimization process. Larger the alpha,
            less of the second order information is used to perform the update.
        hessian_period : int
            Computed hessian is being cached during optimization. This may accelerate the optimization
            if computation of the hessian is taking too long.
            hessian_period=1 means that the hessian will be recalculated on each step.
            hessian_period=3 means that the hessian will be recalculated every 3rd step.
        name : str
            Name of the optimizer. Used to define the scope of the operations.
        """
        self._name = name
        self._alpha = alpha
